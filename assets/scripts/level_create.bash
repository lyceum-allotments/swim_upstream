convert -size 800x600 xc:   -seed 123 +noise Random   random.png
...
sed "s/MagickImage/level1_array/" test.h > ../../level1.h
rm test.h

convert -sample 80x60 random_10_blobs.png test.png

convert random_10_blobs.png +level-colors \#031a91,\#b4fdf7 ../level1.png
